...
@Component({
  ...
  template: `
    ...
    >
      <div>
        <h1 class="text-4xl mt-10 font-bold md:mt-0">
          Hello, <br />
            ...
            <pre ngNonBindable>
               <code>
                ...
                <span class="text-[var(--symbol)] ml-2">&#125;</span> else <span class="text-[var(--symbol)]">&#123;</span>
                  <span class="text-[var(--skill)] ml-6">console.log</span><span class="text-[var(--symbol)]">('</span>Still learning new skills!<span class="text-[var(--symbol)]">')</span>;
                <span>&#125;</span>
              </code>
            </pre>
          </div>
      ...
      <div
        class="relative h-[300px] py-8 md:col-span-2 flex justify-center items-center"
      >
